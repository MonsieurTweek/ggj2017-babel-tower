...
namespace GifEncoder
{
	public class AnimatedGifEncoder
	{
        ...
        /// </summary>
		/// 
		/// Damien 21/01/2017 : Create a new type 'GifFrame2D' to be able to encoding in another thread.
		/// (Texture2D like many other Unity3D type is not accecible when it's not in the main thread).
		/// 
        public void AddFrame(GifFrame2D frame) 
		{
            if (!this.sizeSet)
            {
            ...
            this.currentFramePixels = frame.pixels;
